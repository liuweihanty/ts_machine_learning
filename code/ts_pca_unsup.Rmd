...
Positive correlated variables point to the same side of the plot. Negative correlated variables point to opposite sides of the graph. We see screens clusters into 3 clusters by their relateness
```{r, fig.width = 6, fig.height=6}
#you can use a geom = "arrow" argument inside fviz_pca_var to only show the arrows, use "geom = c("arrow","text") to show both arrow and text.
fviz_pca_var(pr.out,
...
We expect the genes to be different on PCA, adn it is what we see here
