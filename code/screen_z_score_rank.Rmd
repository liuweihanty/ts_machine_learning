...
```{r}
ery.byplate.test.p <- t_test(ery.byplate.test,0.1)[[1]]
ery.hits <- t_test(ery.byplate.test,0.1)[[2]]

pro.byplate.test.p <- t_test(pro.byplate.test,0.01)[[1]]
pro.hits <- t_test(pro.byplate.test,0.01)[[2]]
```
