...
save_pheatmap_jpeg(cont_heatmap,"/Users/weihan/Documents/GitHub/ts_machine_learning/data/Final_Figures/heatmap_cont.jpg",12,24,300)
...
color.palette.bi  <- colorRampPalette(c("#0066CC", "#CC0000"))(length(palette.breaks) - 1)

pheatmap(select(grand_sheet_z_binary,-"sort"),
         color = color.palette.bi,
...
save_pheatmap_jpeg(cont_heatmap,"/Users/weihan/Documents/GitHub/ts_machine_learning/data/Final_Figures/heatmap_bi.jpg",12,24,300)        
